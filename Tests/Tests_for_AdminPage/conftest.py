...
def deleting_user_from_group():
    ...
    varfile = open('/Volumes/Work/Python_courses/Project/Final_project/Tests/Tests_for_AdminPage/var.txt')
...
def logs_admin_page():
    ...
    formatter = logging.Formatter(
        "[%(asctime)s] -- [%(levelname)s][%(lineno)d]--[%(name)s->Tests_for_AdminPage]: \n%(message)s")
